...
if __name__ == "__main__":
    ...
    sim.add_shell_with_scale_3D("input/ribbon" + size + ".obj", Vector3d(0, 0, 0), Vector3d(0.05, 0.05, 0.05), \
        Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0)

    # v, rotCenter, rotAxis, angVelDeg
    sim.set_DBC(Vector3d(-0.1, -0.1, -0.1), Vector3d(1e-2, 1.1, 1.1), 
        Vector3d(-0.1, 0, 0), Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0)
    sim.set_DBC(Vector3d(1-1e-2, -0.1, -0.1), Vector3d(1.1, 1.1, 1.1), 
        Vector3d(0.1, 0, 0), Vector3d(0, 0, 0), Vector3d(1, 0, 0), 0)
